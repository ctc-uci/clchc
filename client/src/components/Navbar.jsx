      ...
      px={4}>
        <Flex gap="3" width="100%" justify="space-evenly">
            ...
            {role !== "viewer" && role !== "ccs" ? (
                <>
                <Link as={NavLink} to="/user-directory" style={activeStyle} {...baseLinkProps}>
                User Directory
                </Link>
                <Link as={NavLink} to="/version-log" style={activeStyle} {...baseLinkProps}>
                Version Log
                </Link>
            </>
            ) : (<></>)}

            <Link as={NavLink} to="/settings" style={activeStyle} {...baseLinkProps}>
            Settings
            </Link>
